...
The win rate for initially guessing $300 is the same as for initially guessing $600 - `r with(exp_val, win_rate[guess == 300]) * 100`%. However the expected value for initially guessing $300 is just $`r round(with(exp_val, exp_val[guess == 300]))`, compared to initially guessing $600 ($`r round(with(exp_val, exp_val[guess == 600]))`). But which actual values can you win before you run out of attempts?
